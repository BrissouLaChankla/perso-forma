...
export default function Signature() {
  return (
    <div className="w-full flex gap-4 mt-28 items-center justify-center">
      <div className="">
        <Image src="/assets/logo.svg" width={200} height={200} className="w-40" />
      </div>
      <div className="text-left w-6/12 px-6">
      ...
      <div>
        <Image src="/assets/badge.png" width={100} height={100} className="w-16" />
      </div>
