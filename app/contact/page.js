                ...
                <div className='grid grid-cols-5 gap-24 mt-12'>
                    ...
                    <div className="flex flex-col gap-8 col-span-2 justify-center ">
                        ...
                        <div className="relative">
                            <svg class="absolute -top-5 -start-5 h-10 w-10 text-gray-100 z-0" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
