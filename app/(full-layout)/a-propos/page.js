...
export default function About() {
  return (
    <>
      <div className="bg-stone-50 rounded-3xl px-8 pt-8 lg:px-16 flex flex-col lg:flex-row w-full lg:mt-6 m-auto items-center overflow-hidden">
        <div className="lg:w-3/5 lg:mb-12">
          ...
          <p className="md:text-xl opacity-90 text-base max-w-xl">
            Salut, je suis un <strong>développeur web freelance basé à Nice</strong>. Avec {new Date().getFullYear() - 2018} années d'expérience, j'ai acquis une expertise solide dans la création de sites web et d'applications.
          </p>
          <br />
          <p className="md:text-xl opacity-90 text-base max-w-xl">
          ...
          <br />
          <a href="https://brice-eliasse.com" target="_blank" className="link">Pour en savoir +</a>
          <br />     <br />
      ...
      <div className="flex py-12">
        ...
        <div className="w-4/12 relative">
          <Image src="/assets/stand_up.svg" fill={true} alt="Illustration moi debout" />
        </div>
